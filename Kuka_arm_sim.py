...
kuka_allegro_hand_biotac = p.loadURDF("robot_arm_hand.urdf",[0, 0, 0], useFixedBase=1)
...
joint_cmd = [0 for _ in range(5)]
p.setJointMotorControlArray(kuka_allegro_hand_biotac, range(5), p.POSITION_CONTROL,  targetPositions=joint_cmd)
